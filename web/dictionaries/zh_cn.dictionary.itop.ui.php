...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:AuditRule/Attribute:valid_flag+' => '若规则返回有效对象则 True,否则 False',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:URP_StimulusGrant+' => '对象生命周期中权限调整',
...
<li>管理 IT 中最重要的资产: 文档.</li>
	...
	'UI:TruncatedResults' => '显示 %1$d 项,共 %2$d 项',
	'UI:DisplayAll' => '全部显示',
	'UI:CollapseList' => '收起',
	'UI:CountOfResults' => '%1$d 项',
	...
	'UI:Title:CSVImportStep2' => '第 2 步,共 5 步: CSV 数据选项',
	'UI:Title:CSVImportStep3' => '第 3 步,共 5 步: 数据映射',
	'UI:Title:CSVImportStep4' => '第 4 步,共 5 步: 模拟导入',
	'UI:Title:CSVImportStep5' => '第 5 步,共 5 步: 完成导入',
	...
	'UI:Schema:MoreInfo+' => '该字段在数据库中被定义的更多信息',
	'UI:Schema:SearchCriteria' => '搜索条件',
	'UI:Schema:FilterCode' => '筛选器编码',
	...
	'UI:LinksWidget:Autocomplete+' => '请输入前 3 个字符...',
	'UI:Edit:TestQuery' => '测试查询',
	'UI:Combo:SelectValue' => '--- 请选择 ---',
	'UI:Label:SelectedObjects' => '已选择的对象: ',
	...
	'UI:UserManagement:Action:Read+' => '读取/查看 对象',
	...
	'UI-ServiceManagementOverview-CustomerContractToRenew' => '客户合同需在 30 天内更新',
	'UI-ServiceManagementOverview-ProviderContractToRenew' => '供应商合同需在 30 天内更新',
...
当与一个触发器关联时, 每个操作都被赋予一个顺序号, 规定了按什么样的顺序执行这些操作.</p>~~',
	...
	'UI:Relation:AttachmentExportOptions_Name' => ' %1$s 的附件选项',
	...
	'Portal:SelectService' => '请从类别中选择一项服务:',
	...
	'Portal:EnterYourCommentsOnTicket' => '请备注该工单的解决方案:',
	...
	'UI:Pagination:HeaderSelection' => '共: %1$s 项(已选择 %2$s 个).',
	'UI:Pagination:HeaderNoSelection' => '共: %1$s 项.',
	'UI:Pagination:PageSize' => '每页 %1$s 项',
	'UI:Pagination:PagesLabel' => '页:',
	'UI:Pagination:All' => '全部',
	'UI:HierarchyOf_Class' => '%1$s 层级',
	'UI:Preferences' => '首选项...',
	'UI:ArchiveModeOn' => '开启归档模式',
	'UI:ArchiveModeOff' => '禁用归档模式',
	...
	'UI:UseSpecificSettings' => '使用下面的设置:',
...
<tr><td>s</td><td>秒 (2位数, 例如 00..59)</td></tr>
	...
	'ExcelExporter:ExportMenu' => '导出 Excel...',
	'ExcelExporter:ExportDialogTitle' => '导出 Excel',
	...
	'portal:backoffice' => ITOP_APPLICATION_SHORT.' 后台界面',
