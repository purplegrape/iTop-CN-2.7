...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:Action/Attribute:status/Value:disabled+' => '停用',
	'Class:Action/Attribute:trigger_list' => '关联的触发器',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:TriggerOnThresholdReached/Attribute:stop_watch_code' => '计时器',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:SynchroDataSource/Attribute:notify_contact_id' => '通知',
	...
	'Class:SynchroDataSource/Attribute:full_load_periodicity' => '运行频率',
	...
	'Core:BulkExport:NoFieldSelected' => '请选择至少导出一列',
	...
	'Core:BulkExport:TextFormat' => '文本中包含一些 HTML 标记',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:TagSetFieldData/Attribute:code+' => '内部编码. 必须至少包含 3 个数字或字母',
