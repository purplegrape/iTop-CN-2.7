...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:Ticket/Attribute:org_name' => '名称',
	...
	'Class:Ticket/Attribute:agent_name' => '名称',
	...
	'Class:Ticket/Attribute:contacts_list+' => '该工单关联的所有联系人',
	'Class:Ticket/Attribute:functionalcis_list' => '配置项',
	'Class:Ticket/Attribute:functionalcis_list+' => '该工单关联的所有配置项.',
	'Class:Ticket/Attribute:workorders_list' => '工作任务',
	'Class:Ticket/Attribute:workorders_list+' => '该工单关联的所有工作任务',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:lnkFunctionalCIToTicket/Attribute:ticket_ref' => '编号',
	'Class:lnkFunctionalCIToTicket/Attribute:ticket_ref+' => '',
	'Class:lnkFunctionalCIToTicket/Attribute:ticket_title' => '标题',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:cmdbAbstractObject/Method:SetElapsedTime' => '设置运行时间',
