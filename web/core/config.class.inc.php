 ...
 */
define('ITOP_VERSION', '2.7.8');

define('ITOP_REVISION', '10409');
define('ITOP_BUILD_DATE', '2022-12-12 14:12:31');
...
class Config
{
	...
	protected $m_aSettings = array(
		...
		'export_pdf_font' => array( // @since 2.7.0 PR #49 / N°1947
			...
			'default' => 'DroidSansFallback', // DejaVuSans is a UTF-8 Unicode font, embedded in the TCPPDF lib we're using
